...
export const posts: SeedPost[] = [
  {
    ...
    content:
      'We had a good season #Sadness #NextYear',
  ...
  },
  {
    ...
    title: 'Big Tree Fans',
    content:
      'Absolutely stunning collection of bonsai trees! So peaceful and meditative. A hidden gem in DC. #Nature #Peaceful #Educational',
...
export const postFavorites: SeedPostFavorite[] = [
