...
describe('UserController', () => {
    ...
    describe('getUser', () => {
        test('should return user when found', () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: 1,
            ...
            yield getUser(mockRequest, mockResponse);
        ...
        test('should handle database errors', () => __awaiter(void 0, void 0, void 0, function* () {
            mockRequest.params = { cognitoId: 'cognito123' };
    ...
    describe('createUser', () => {
        test('should create user successfully', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield createUser(mockRequest, mockResponse);
    ...
    describe('updateUser', () => {
        test('should update user successfully', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const updatedUser = Object.assign({ id: 1, cognitoId: 'cognito123' }, updateData);
            mockRequest.params = { cognitoId: 'cognito123' };
            mockRequest.body = updateData;
            mockPrismaInstance.user.update.mockResolvedValue(updatedUser);
            yield updateUser(mockRequest, mockResponse);
        ...
        test('should handle user not found during update', () => __awaiter(void 0, void 0, void 0, function* () {
            mockRequest.params = { cognitoId: 'nonexistent' };
    ...
    describe('addFavoritePost', () => {
        test('should add favorite post successfully', () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: 1,
                cognitoId: 'cognito123',
                username: 'testuser',
            ...
            const updatedUser = Object.assign(Object.assign({}, mockUser), { favoritePosts: [{ post: mockPost }] });
            ...
            yield addFavoritePost(mockRequest, mockResponse);
        ...
        test('should return 404 when post not found', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('should return 400 when post already favorited', () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = { id: 1, cognitoId: 'cognito123' };
    ...
    describe('removeFavoritePost', () => {
        test('should remove favorite post successfully', () => __awaiter(void 0, void 0, void 0, function* () {
            const mockUser = {
                id: 1,
                cognitoId: 'cognito123',
                username: 'testuser',
            };
            const updatedUser = Object.assign(Object.assign({}, mockUser), { favoritePosts: [] });
            mockRequest.params = { cognitoId: 'cognito123', postId: '5' };
            mockPrismaInstance.user.findUnique
                .mockResolvedValueOnce(mockUser) // First call to find user
                .mockResolvedValueOnce(updatedUser); // Final call to return updated user
            mockPrismaInstance.postFavorite.delete.mockResolvedValue({ id: 1 });
            yield removeFavoritePost(mockRequest, mockResponse);
