...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const ownerUser = yield prisma.user.findUnique({ where: { email: 'owner@sunnycafe.com' } });
        for (const location of seedData_1.locations) {
            ...
            const claimedByUserId = location.name === "Sunny Cafe" ? ownerUser === null || ownerUser === void 0 ? void 0 : ownerUser.id : null;
